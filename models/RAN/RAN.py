...
class RAN(nn.Module):
    def __init__(self, embedding_size, vocab_size, hidden_size, tie_weights, nlayers, dropout, cuda):
        ...
        for layer in range(self.nlayers):
            ...
            # REASON FOR CODE: if weights are not an attribute of class network does not train correctly
    ...
    def forward(self, word, h_s, l_s, content=0, weight_analysis=False):
